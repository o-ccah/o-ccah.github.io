...
* [付値体のノート](docs/valued-field-20191117.pdf)
  ...
  付値体の定義からはじめ，Q上の絶対値の分類や複素係数と実係数それぞれの場合のGelfand--Mazurの定理を経由して，Ostrowskiの定理を証明します．Ostrowskiの定理とは，Archimedes的な完備付値体がR, C, Hのいずれかに同値であるという定理です．おまけとして，付録では，Frobeniusの定理（体をなす有限次元単位的R-代数がR, C, Hのいずれかに同型である）を証明します．
