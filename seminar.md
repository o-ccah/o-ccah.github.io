...
このゼミの内容（スペクトル分解に関する部分を除く）は，[トップページ](index.md)にある「Gelfand理論のノート」にまとめてあります．
...
* 第3回 2019/12/11 (水)
  ...
  内容: GelfandスペクトルとGelfand変換を定義し，基本的な性質を見た．例として，C(X)とl^1(Z)のGelfandスペクトルとGelfand変換を求めた．応用として，Wienerの1/f定理を示した．
