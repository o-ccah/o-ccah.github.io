...
2021/03/31: [このページ](https://qiita.com/memakura/items/e4d2de379f98ad7be498)を参考にして，MathJax を使えるようにしました．テスト: $ e^{i\theta} = \cos \theta + \sin i\theta $．

2021/03/30: 映画「七つの会議」を観ました．最初は話にまとまりがないように感じましたが，話が進んで構造が見えてくるとそれらが一つの物語としてまとまっていき，とても面白く観ることができました．前半は推理が，後半は人間ドラマがメインとなっているのですが，これらが一つの作品の中にあって互いに他の邪魔をしていない点がすごいと思いました．

2021/03/24: Markdown で，段落内に箇条書きや引用を挿入するとき，箇条書きや引用の前後に空行は入れるべきなんでしょうか？ いまのところは入れることにしているのですが．

2021/03/24: 下の疑問に関連して，どのような位相空間 X に対して「X の自己連続全単射は同相である」といえるのか，気になります．たとえば，コンパクト Hausdorff 空間や境界をもたない純次元の位相多様体は，この性質を満たします（後者は，領域不変性定理の結果）．この性質を満たさない例としては，[0, 1) と S^1 を可算無限個ずつ直和した空間があります．では，たとえば，数直線の可算無限積 R^N や，無限次元可分 Hilbert 空間 l^2(N) は，この性質を満たすでしょうか？

2021/03/24: ファイバー束・主束に関して生じた疑問について考えました．長くなったので[別のページ](diary-files/096708dbee33.md)にまとめました．

2021/03/17: 「相棒 19」の最終回を観ました．続きが気になる終わり方でした．

2021/03/17: 「[対称多項式の基本定理](docs/symmetric-polynomial.md)」を公開しました．

2021/03/14: 某イベントに参加しました．面白い発表が聴けて，人とも話せて，とても楽しかったです．
