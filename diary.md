...
2021/04/25: 「叛逆の物語」の続編，「劇場版 魔法少女まどか☆マギカ 〈ワルプルギスの廻天〉」の制作が[決定したようです](https://www.madoka-magica.com)．
...
2021/03/24: 下の疑問に関連して，どのような位相空間 $ X $ に対して「$ X $ の自己連続全単射は同相である」といえるのか，気になります．たとえば，コンパクト Hausdorff 空間や境界をもたない純次元の位相多様体は，この性質を満たします（後者は，領域不変性定理の結果）．この性質を満たさない例としては，$ [0, 1) $ と $ S^1 $ を可算無限個ずつ直和した空間があります．では，たとえば，数直線の可算無限積 $ \mathbb{R}^{\mathbb{N}} $ や，無限次元可分 Hilbert 空間 $ l^2(\mathbb{N}) $ は，この性質を満たすでしょうか？
