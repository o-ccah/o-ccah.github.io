...
* [Fourier級数のノート](docs/fourier-series-20200509.pdf)
  ...
  2020/05/09: 誤植などを修正し，Poissonの和公式についての解説を加えました．また，欧文フォントが変わっています．

* [付値体のノート](docs/valued-field-20200509.pdf)
...
* [Gelfand理論のノート](docs/gelfand-20200420.pdf)
  ...
  2020/03/20: 単位的C\*代数の正元，単位的C\*代数上の正値線型形式や状態，Gelfand--Naimark--Segal構成についての解説を加え，任意の単位的C\*代数がある作用素のなす単位的C\*代数に同型であることの証明も載せました．正元に関連して，連続線型作用素の極分解についても触れました．
